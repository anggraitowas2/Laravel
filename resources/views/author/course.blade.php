  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Data Courses</h3>
        <!-- @if(session('sukses'))
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Statement</label>
    <input name="statement"type="text" class="form-control" id="exampleInput" placeholder ='Enter your statement Bro'>
  </div>
<div class="mb-3">
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone"><i class="fa fa-question-circle"></i>Statement</th>
...
<!-- Modal -->
<div class="modal fade" id="edit{{$course->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Name</label>
    <input value="{{$course->name}}" name="name"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder ='Enter your name Bro'>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Statement</label>
    <input value="{{$course->statement}}"name="statement"type="text" class="form-control" id="exampleInput" placeholder ='Enter your statement Bro'>
  </div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Picture</label>
  <input value="{{$course->picture}}"name="picture" type="file" accept="image/png image/jpeg image/jpg" class="form-control" id="exampleFormControlTextarea1" rows="3"></input>
</div>
