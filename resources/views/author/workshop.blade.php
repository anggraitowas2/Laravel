  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i>Data Workshop</h3>
        <!-- @if(session('sukses'))
              ...
              <table class="table table-striped table-advance table-hover">
                ...
                <tbody>
                  ...
                  @foreach($workshops as $workshop)
                    <td>{{$workshop->name}}</td>
                    <td><img src="{{ URL::to($workshop->picture) }}" alt="" width="100" 
                            height="80"></td>
                    <td><div class="col-lg-12"><!-- Button trigger modal -->
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#edit{{$workshop->id}}">
  Edit
</button>
<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete{{$workshop->id}}">
  Delete
</button>

<!-- Modal -->
<div class="modal fade" id="edit{{$workshop->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Name</label>
    <input value="{{$workshop->name}}" name="name"type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder ='Enter your name Bro'>
  </div>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Picture</label>
  <input value="{{$workshop->picture}}"name="picture" class="form-control" id="exampleFormControlTextarea1" rows="3"></input>
</div>
...
<!-- Modal -->
<div class="modal fade" id="delete{{$workshop->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
